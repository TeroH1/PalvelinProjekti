...
auto eno1
	...
	address 10.10.1.{eno}/31        
	mtu 9216
	#TO_FABRIB_L2A_ETH1
	
auto eno2
	iface eno2 inet static
	address 10.10.2.{eno}/31
	mtu 9216
	#TO_FABRIC_L2B_ETH1
	
auto enroute0
	iface enroute0 inet static
	address 10.2.1.{lo}/32
	mtu 9216
...
auto vxlan7001
	...
	pre-up ip link add vxlan7001 type vxlan id 7001 dstport 4789 local 10.2.1.{lo} nolearning
